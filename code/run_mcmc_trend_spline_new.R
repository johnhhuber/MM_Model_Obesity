...
# specify the file path to thep posterior 
file.post = args[2]
...
# bayesian set up 
params_lower <- c(-10,
                  rep(-10,length(knots_x_period)-1),
...
settings = list(iterations = 1e4, message = T)
...
print(paste(path.out, 'posterior_', chain, '.csv', sep = ''))
